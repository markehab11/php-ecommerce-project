			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							<a href="blog-detail.php?idblog=<?php echo $row['id'] ?>" class="hov-img0 how-pos5-parent">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="blog-detail.php?idblog=<?php echo $row['id'] ?>" class="ltext-108 cl2 hov-cl1 trans-04">
