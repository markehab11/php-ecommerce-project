				...
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="wrap-pic-w how-pos5-parent">
							<img src="cozadash/upload/<?php echo $row['blog_img'] ?>" alt="IMG-BLOG">
						...
						<?php
							...
							$stmt_com = $coon->prepare('SELECT * FROM comment WHERE id_blog = ?');
							$stmt_com->execute([$id]);
							while($row_com = $stmt_com->fetch()){

								echo $row_com['name'] . '<br>';
								echo $row_com['comment'] . '<br>';
							}
		...
		$(document).ready(function(e){
			$("#blogcomment").on('submit', function(e){
				...
				$.ajax({
					...
					type: 'POST',
					url: 'fun/add_comment.php',
					data: new FormData(this),
					contentType: false,
					cashe: false,
					processData: false,
					beforeSend: function(){
						$('#blogcomment').css('opacity', '.5');
					},
					success: function(msg){
						$('#add').html('');
						$('#blogcomment')[0].reset();
						$('#add').html(msg);
						$('#blogcomment').css('opacity', '');
					}
				});			
			});
		})
